...
import { createCapability, CreateCapabilityError } from '../structure/create-capability.js';
import {
  readManifestView,
  patchManifestSoftFields,
  acquireRegenerateFieldJob,
  patchSelection,
} from '../structure/structure-edit-repo.js';
import { createStructureJob, structureEventsUrl } from '../structure/create-structure-job.js';
