...
import { initialImportProgress } from '../import/create-job.js';
import { readJobViewForRecovery } from '../import/upload-manifest-repo.js';
...
export function connectScriptHandler(): RouteHandlerMethod {
  return async function (req: FastifyRequest, reply: FastifyReply) {
    ...
    try {
      const { hashPairingCode } = await import('../middleware/pair-auth.js');
