// B-14 · consumer 路由表（70 §1/§3）。机制与业务的【组合根】：events 引擎不 import 任何业务投影，
//   路由表在进程侧（processes/）组装——import 各业务域 index 的 processor，再注入 events 引擎消费框架。
//   按 ACTIVE_OUTBOX_TOPICS 把 topic 分派到 consumer：
...
import type { ConsumerTopicConfig, EventProcessor } from '../platform/events/consumer-core.js';
import { marketplaceProjection } from '../modules/publish/index.js';
import { notifyConsumer } from '../modules/notifications/index.js';
