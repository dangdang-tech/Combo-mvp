...
import { hashPairingCode } from '../platform/middleware/pair-auth.js';
import {
  buildConnectCommand,
  ...
  readPairingStatus,
  recordPartLanded,
} from '../modules/import/pairings-repo.js';
import { renderConnectScript, renderExpiredScript } from '../modules/import/connect-script.js';
import { readPairingManifest } from '../modules/import/pairings-repo.js';
import {
  connectBinHandler,
  connectPairHandler,
...
} from '../modules/import/import-connect.js';
