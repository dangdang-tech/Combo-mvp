...
import { createExtractHandler } from '../modules/extract/job.js';
import type { JobEventBridge, QueryResultLike } from '../platform/jobs/types.js';
import type { TxConn } from '../platform/events/db-tx.js';
import {
  ExtractFakeDb,
  ExtractFakeTxPool,
  FakeLlmGateway,
